...
function additionaCommissionCodeStep2OnSaveClickSchema(player: any) {
  ...
  //     [`${item}disbursementPolicy`]: genValidation({
  //       type: "object",
  //       isRequired: true,
  //       isNullable: true,
  //     }),
  //     [`${item}disbursementApproval`]: yup
  //       .object()
  //       .when([`${item}disbursementPolicy`], {
  ...
  //         }),
  //       }),
  //     [`${item}thresholdAmount`]: yup
  //       .number()
  //       .when([`${item}disbursementApproval`], {
  ...
  if (player && player.length > 0) {
    ...
    player.map((item: any) => {
      Object.assign(commissionCodeObj, {
        [`${item}ChargeType`]: genValidation({
          type: "object",
          isRequired: true,
          isNullable: true,
        }),
        [`${item}Charge`]: yup.string().when(`${item}ChargeType`, {
          is: (ChargeType: any) => {
        ...
        [`${item}MinCharge`]: yup.string().when([`${item}ChargeType`], {
          is: (ChargeType: any) => {
            return ChargeType && ChargeType?.chargeType === "PERCENTAGE"
          },
          then: yup
            ...
            .test(
              ...
              (value: number | undefined | null | string, context: any) => {
                const MaxCharge = context.parent[`${item}MaxCharge`]
        ...
        [`${item}MaxCharge`]: yup.string().when([`${item}ChargeType`], {
          is: (ChargeType: any) => {
            return ChargeType && ChargeType?.chargeType === "PERCENTAGE"
          },
          then: yup
            ...
            .test(
              ...
              (value: number | undefined | null | string, context: any) => {
                const MinCharge = context.parent[`${item}MinCharge`]
        ...
        [`${item}FixCharge`]: yup.string().when([`${item}ChargeType`], {
          is: (ChargeType: any) => {
        ...
        [`${item}Vat`]: yup.string().when([`${item}ChargeType`], {
          is: (ChargeType: any) => {
            return (
              ChargeType &&
