    ...
    priceCode: yup
      ...
      .of(
        yup.object().shape({
          ...
          senderCharge: yup.string().when(["contributor", "senderChargeType"], {
          ...
          senderVat: yup.string().when(["contributor", "senderChargeType"], {
            is: (contributor: string, senderChargeType: any) => {
              return (
                contributor &&
                (contributor === "Sender" || contributor === "Both") &&
          ...
          receiverChargeType: yup.object().when("contributor", {
            is: (contributor: string) => {
              return (
                contributor &&
