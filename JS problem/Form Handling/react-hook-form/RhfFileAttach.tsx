...
import { IDefaultValueObject, TRhfFileAttach } from "../../../models/formFields"
    ...
    if (uploadRef.current) {
      ...
      if (tempFile) {
        ...
        if (fileName.includes(" ")) {
          ...
          setError(name, {
            type: "custom",
            message: customError || "Invalid File format .",
          })
          setTimeout(() => {
            trigger(name)
          }, 1000) //
