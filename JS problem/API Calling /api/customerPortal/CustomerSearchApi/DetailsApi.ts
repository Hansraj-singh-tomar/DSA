...
function changeMerchantgCategory(body: any) {
  return httpRequest(authContext()).post(
...
function merchantTypeVersionList(body: any) {
  return httpRequest(authContext()).post(
...
function userTypeVersionList(body: any) {
  return httpRequest(authContext()).post(
    "api/sysportal/merchanttype/v1/list-user-type-versions",
    body,
    {
...
function changeProfilePin(body: any) {
  return httpRequest(authContext()).post(
...
export {
  ...
  downloadKycData,
  changeMerchantgCategory,
  changeProfilePin,
  userTypeVersionList,
  merchantTypeVersionList,
}
